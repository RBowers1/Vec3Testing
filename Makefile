...
# Project:  Vec3Tests.pro
# Template: app
# Command: /opt/Qt5.11.1/5.11.1/gcc_64/bin/qmake -o Makefile Vec3Tests.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
CXXFLAGS      = -pipe -std=c++1z -Wall -Wextra -g -g -std=gnu++11 -Wall -W -D_REENTRANT -fPIC $(DEFINES)
INCPATH       = -I. -isystem /usr/local/include -I/opt/Qt5.11.1/5.11.1/gcc_64/include -I/opt/Qt5.11.1/5.11.1/gcc_64/include/QtGui -I/opt/Qt5.11.1/5.11.1/gcc_64/include/QtCore -I. -isystem /usr/include/libdrm -I/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/linux-clang
...
COMPRESS      = gzip -9f
DISTNAME      = test1.0.0
DISTDIR = /home/s5001892/CGAA/Vec3/.tmp/test1.0.0
LINK          = clang++
LFLAGS        = -ccc-gcc-name g++ -Wl,-rpath,/opt/Qt5.11.1/5.11.1/gcc_64/lib
LIBS          = $(SUBLIBS) -L/usr/local/lib -lgtest -lgtest_main -pthread -L/opt/Qt5.11.1/5.11.1/gcc_64/lib -lQt5Gui -lQt5Core -lGL -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
OBJECTS       = Vec3.o \
		Vec3Tests.o
DIST          = /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/spec_pre.prf \
		...
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/clang.conf \
		...
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/linux-clang/qmake.conf \
...
Makefile: Vec3Tests.pro /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/linux-clang/qmake.conf /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile Vec3Tests.pro -spec linux-clang CONFIG+=debug CONFIG+=qml_debug
...
distdir: FORCE
	...
	$(COPY_FILE) --parents Vec3.h $(DISTDIR)/
	$(COPY_FILE) --parents Vec3.cpp Vec3Tests.cpp $(DISTDIR)/
...
moc_predefs.h: /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/data/dummy.cpp
	clang++ -pipe -std=c++1z -Wall -Wextra -g -g -std=gnu++11 -Wall -W -dM -E -o moc_predefs.h /opt/Qt5.11.1/5.11.1/gcc_64/mkspecs/features/data/dummy.cpp
...
Vec3Tests.o: Vec3Tests.cpp Vec3.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o Vec3Tests.o Vec3Tests.cpp
